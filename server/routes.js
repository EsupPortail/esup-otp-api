...
exports.initialize = function(server, userDb_controller, apiDB_controller, callback) {
    ...
    server.get("/available_transports/:uid", validator.get_available_transports, userDb_controller.get_available_transports);
    server.get("/activate_methods/:uid", validator.get_activate_methods, apiDB_controller.get_activate_methods);
