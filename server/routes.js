...
async function initializeEsupAuthRoutes(server) {
    ...
    server.post("/users/:uid/methods/push/activate/:activation_code/:platform/:manufacturer/:model", api_controller.confirm_activate_push);
    server.post("/users/:uid/methods/:method/refresh/:tokenSecret/:gcm_id/:gcm_id_refreshed", api_controller.refresh_gcm_id_method);
    server.post("/users/:uid/methods/:method/refresh/:tokenSecret/:gcm_id_refreshed", api_controller.refresh_gcm_id_method);
...
async function initializeNfcRoutes(server) {
    ...
    server.get("/esupnfc/infos.svg", esupnfc_controller.getSVG);
}
