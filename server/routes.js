...
export function initialize(server) {
    ...
    return Promise.all([
        ...
        initializeTenantsRoutes(server),
    ]).then(() => {
...
async function initializeProtectedRoutes(server) {
    ...
    server.get("/protected/users", validator.check_restricted_access, api_controller.get_uids);
    ...
    server.del("/protected/users/:uid/methods/:method/secret", validator.check_restricted_access, api_controller.delete_method_secret);
